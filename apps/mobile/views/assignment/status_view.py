...
class AssignmentStatusView(APIView):
    ...
    - Vérification de la limite de 5 assignments ENTAME par utilisateur et par inventaire
    ...
    - 400: Transition de statut invalide, assignment déjà entamé, ou limite d'assignments ENTAME atteinte (max 5)
    - 401: Non authentifié
                ...
                schema=openapi.Schema(
                    ...
                    properties={
                        ...
                        'error': openapi.Schema(
                            ...
                            example='Vous ne pouvez pas lancer (entamer) cet assignment car vous avez déjà 5 assignments en statut ENTAME pour le même inventaire. Maximum autorisé: 5.'
                        )
                    }
                )
            ),
