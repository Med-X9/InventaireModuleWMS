...
class UnblockAssignmentView(APIView):
    ...
    Vérifie également qu'il n'y a pas déjà 5 assignments ENTAME pour le même utilisateur et inventory.
    ...
    - Vérification qu'il n'y a pas déjà 5 assignments ENTAME pour le même inventory
    ...
    @swagger_auto_schema(
        ...
        operation_description="Débloque un assignment en changeant son statut vers ENTAME. Seuls les assignments en statut bloqué peuvent être débloqués. Vérifie également qu'il n'y a pas déjà 5 assignments ENTAME pour le même inventory. L'utilisateur est récupéré depuis le token d'authentification",
        manual_parameters=[
            openapi.Parameter(
                'assignment_id',
                openapi.IN_PATH,
                ...
                schema=openapi.Schema(
                    ...
                    properties={
                        ...
                        'error': openapi.Schema(
                            ...
                            example='Vous ne pouvez pas débloquer cet assignment car vous avez déjà 5 assignments en statut ENTAME pour le même inventaire (maximum: 5). Pour débloquer, vous devez terminer ou bloquer un assignment.'
                        )
                    }
                )
            ),
