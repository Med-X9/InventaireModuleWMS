...
urlpatterns = [
    ...
    path('sync/data/user/<int:user_id>/', views.SyncDataView.as_view(), name='mobile_sync_data_by_user'),
    path('sync/upload/', views.UploadDataView.as_view(), name='mobile_upload_data'),
    
    # Utilisateurs du même compte d'inventaire
    path('inventory/<int:inventory_id>/users/', views.InventoryUsersView.as_view(), name='mobile_inventory_users'),
