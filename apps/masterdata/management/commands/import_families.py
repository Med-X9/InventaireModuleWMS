"""
Commande Django pour importer des familles depuis un fichier Excel/CSV
Usage: python manage.py import_families --file path/to/file.xlsx
"""
from django.core.management.base import BaseCommand, CommandError
from django.db import transaction
from apps.masterdata.admin import FamilyResource
from import_export.formats.base_formats import XLSX, CSV, XLS
import os


class Command(BaseCommand):
    help = 'Importe des familles depuis un fichier Excel/CSV'
