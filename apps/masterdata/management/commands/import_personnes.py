"""
Commande Django pour importer des personnes depuis un fichier Excel/CSV
Usage: python manage.py import_personnes --file path/to/file.xlsx
"""
from django.core.management.base import BaseCommand, CommandError
from django.db import transaction
from apps.masterdata.admin import PersonneResource
from import_export.formats.base_formats import XLSX, CSV, XLS
import os


class Command(BaseCommand):
    help = 'Importe des personnes depuis un fichier Excel/CSV'
