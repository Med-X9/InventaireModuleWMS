...
urlpatterns = [
    ...
    path('warehouses/<int:account_id>/warehouse/<int:warehouse_id>/inventory/<int:inventory_id>/locations/unassigned/', UnassignedLocationsView.as_view(), name='account-warehouse-unassigned-locations'),
