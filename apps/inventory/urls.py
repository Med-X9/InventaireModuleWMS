...
from .views.stock_views import StockImportExcelView
...
urlpatterns = [
    ...
    path('inventory/<int:pk>/soft-delete/', InventorySoftDeleteView.as_view(), name='inventory-soft-delete'),
    path('inventory/<int:pk>/restore/', InventoryRestoreView.as_view(), name='inventory-restore'),
    ...
    # URL pour l'import Excel de stocks
    path('inventory/<int:inventory_id>/import-stocks/', StockImportExcelView.as_view(), name='stock-import-excel'),
